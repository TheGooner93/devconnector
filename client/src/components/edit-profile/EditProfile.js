...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      //If profile field is null, make an empty string
      for (var key in profile) {
        if (key === "social") {
          profile[key] = !isEmpty(profile["social"]) ? profile["social"] : {};
          if (!isEmpty(profile["social"])) {
            for (var sKey in profile["social"]) {
              profile[sKey] = !isEmpty(profile["social"][sKey])
                ? profile["social"][sKey]
                : "";
            }
          }
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="Which company do you work for?"
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
                ...
                <TextFieldGroup
                  ...
                  info="Provide this for awesome Github integration!"
                />
                <TextAreaFieldGroup
